...
nlp="http://www.digital-archiv.at/ns/grundbuecher/nlp" at "../modules/nlp.xqm";
import module namespace util = "http://exist-db.org/xquery/util";
declare namespace tei="http://www.tei-c.org/ns/1.0";

let $collection := '/db/apps/grundbuecher/data/editions/'
let $input := doc('/db/apps/grundbuecher/data/editions/oko.xml')
