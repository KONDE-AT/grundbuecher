...
import module namespace app="http://www.digital-archiv.at/ns/grundbuecher/templates" at "app.xql";
...
declare 
    %rest:GET
    %rest:path("/grundbuecher/{$collection}/{$format}")
...
declare 
    %rest:GET
    %rest:path("/grundbuecher/dt/{$collection}/{$format}")
...
declare 
    %rest:GET
    %rest:path("/grundbuecher/{$collection}/{$id}/{$format}")
